...
{
    protected $tableName = 'shop_message';
    ...
    public function getUserMessageCount(){
        ...
        $user_system_message_no_read = DB::name('user_message')
            ->alias('um')
            ->join('__SHOP_MESSAGE__ m','um.message_id = m.message_id','LEFT')
    ...
    public function checkPublicMessage()
    {
        ...
        $user_system_public_no_read = Db::name('shop_message')->field('message_id')->where($message_where)->select();
