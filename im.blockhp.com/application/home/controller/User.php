...
class User extends Base
{
    ...
    public function _initialize()
    {
        ...
        if (session('?user')) {
            ...
            //获取用户信息的数量
            $user_message_count = D('ShopMessage')->getUserMessageCount();
            ...
            if (ACTION_NAME == 'password') $_SERVER['HTTP_REFERER'] = U("Home/newjoin/index");
        }
    ...
    {
        if ($this->user_id > 0) {
            header("Location: " . U('Home/newjoin/index'));
        }
        $referurl = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : U("Home/newjoin/index");
