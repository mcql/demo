...
class UsersLogic extends Model
{
    ...
    public function login($username,$password){
        ...
        }/*elseif(encrypt($password) != $user['password']){ //不进行验证密码
 ...
 * 获取账户余额记录
 */
    public function get_account_log_spec($user_id, $type = 0, $order_sn = null, $order_start = null, $order_end = null, $desc = null)
    {
        //查询条件
        $where['user_id'] = $user_id;
        if ($type == 1) {
