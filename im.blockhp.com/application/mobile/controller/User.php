...
class User extends MobileBase
{
    ...
    */
    public function _initialize()
    {
        ...
        $nologin = array(
            'login', 'pop_login', 'do_login', 'dologin','logout', 'verify', 'set_pwd', 'finished',
    ...
    public function logouter()
    {
        ...
        //$this->success("退出成功",U('Mobile/Index/index'));
        header("Location:" . U('/Phone/Login/index'));
        exit();
    }
    ...
    public function account()
    {
        ...
        $data = $logic->get_account_log_spec($this->user_id, I('get.type'));
    ...
    {
        $this->redirect('/Phone/Login/index'); //跳转到聊天登陆界面
        if ($this->user_id > 0) {
    ...
    public function reg()
    {
        $this->redirect('/Phone/Login/register');//跳转到聊天注册界面
