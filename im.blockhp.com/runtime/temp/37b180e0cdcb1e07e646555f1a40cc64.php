<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"./template/mobile/new/cart\ajax_cart_list.html";i:1554019046;}*/ ?>
<style type="text/css">
 ...
 <?php if(is_array($cartList) || $cartList instanceof \think\Collection): if( count($cartList)==0 ) : echo "" ;else: foreach($cartList as $k=>$v): ?>
    <div  class="block" style="margin-top:0px;">
      <div class="shop_title" >
        <div class="fl"><a class="shopLink eclipse" href="javascript:void(0);">供货商：<?php echo $storeList[$v[store_id]]; ?></a>
       ...
       <div class="item">
         <div class="inner">
           ...
           <div style=" position:absolute; right:0px; top:20px; width:100px; height:98px;">
             <div class="price">
               <span class="mar_price"><?php echo $v['market_price']; ?> BHP</span>
               <br>
               <span><?php echo $v['member_goods_price']; ?> BHP</span>
              </div>
             <div class="delete">
 ...
 <?php else: ?>
	 <div class="bottom-panel" style="display:flex">
	   ...
	   <div class="info" style="margin-top: 4px;">
	     <span class="hot" id="cart_amount_desc"><em>总计：</em>￥<?php echo $total_price['total_fee']; ?>  BHP</span>
	     <br>
