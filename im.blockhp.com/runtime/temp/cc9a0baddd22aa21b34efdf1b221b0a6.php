<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./template/mobile/new/goods\goodslist.html";i:1554018422;s:44:"./template/mobile/new/public\footer_nav.html";i:1491382656;s:42:"./template/mobile/new/public\wx_share.html";i:1491382656;}*/ ?>
<html>
<head>
  ...
  <?php else: if(is_array($goods_list) || $goods_list instanceof \think\Collection): if( count($goods_list)==0 ) : echo "" ;else: foreach($goods_list as $k=>$vo): ?>
     <li>
		<a href="<?php echo U('Mobile/Goods/goodsInfo',array('id'=>$vo[goods_id])); ?>" class="item">
			...
			<div class="price_box">
				<span class="new_price"><i><?php echo $vo['shop_price']; ?> BHP</i></span>
			</div>
