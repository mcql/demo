<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"./application/admin/view2/finance/store_remittance.html";i:1491382650;s:44:"./application/admin/view2/public/layout.html";i:1491382650;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <table>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 120px;"><?php echo $v['band_card']; ?></div>
                            </td>
                            <td align="center" class="">
