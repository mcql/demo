...
<div class="Wallet">
	<ul>
	<li class="bain1"><strong><?php echo $user['user_money']; ?> BHP</strong><span>余额</span></li>
...
<div class="Wallet">
	<a href="<?php echo U('User/logouter'); ?>"><em class="Icon Icon8"></em><dl><dt>注销登录</dt></dl></a>
</div>
</div>
<!--
<div class="footer" >
