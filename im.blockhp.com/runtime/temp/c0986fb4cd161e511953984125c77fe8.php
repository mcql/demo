<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:38:"./template/mobile/new/store/index.html";i:1555685477;s:38:"./template/mobile/new/public/menu.html";i:1555520524;}*/ ?>
<!DOCTYPE html >
<html>
<head>
...
<div class="dianpu_main" style="background: url('<?php echo (isset($store['store_banner']) && ($store['store_banner'] !== '')?$store['store_banner']:'__STATIC__/images/topbg.jpg'); ?>') no-repeat center bottom">
	...
	<dt><img src="<?php echo (isset($store['store_logo']) && ($store['store_logo'] !== '')?$store['store_logo']:'__STATIC__/images/v-shop/logo.png'); ?>" alt="<?php echo $store['store_name']; ?>"></dt>
...
<div id="scrollimg" class="scrollimg">
	<div class="bd">
		<ul>
		<?php if(is_array($store['mb_slide']) || $store['mb_slide'] instanceof \think\Collection): if( count($store['mb_slide'])==0 ) : echo "" ;else: foreach($store['mb_slide'] as $key=>$vimg): if(!(empty($vimg) || ($vimg instanceof \think\Collection && $vimg->isEmpty()))): ?>
...
<script type="text/javascript">
   ...
   <div class="product_value">
  		...
  		<ul>
	        ...
	        <span class="price"> <?php echo $vo['shop_price']; ?>BHP  </span> </a>
	        </li>
