<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/www/wwwroot/im.blockhp.com/application/phone/view/wallet/coinshow.html";i:1555022876;s:69:"/www/wwwroot/im.blockhp.com/application/phone/view/common/header.html";i:1555021777;s:69:"/www/wwwroot/im.blockhp.com/application/phone/view/common/footer.html";i:1554651692;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="deals-head flex-box">
                <div class="flex-box" style="margin: 0 auto;">
                    <button class="weui-btn found-btn weui-btn_primary" style="border-radius: 5px;">
                        <a href="<?php echo url('trade'); ?>?coin=<?php echo $coiName; ?>" style="color:#fff;">
                            转账
                        </a>
                    </button>
                    <button class="weui-btn import-btn weui-btn_primary" style="border-radius: 5px;">
                        <a href="<?php echo url('selfPackage'); ?>?coin=<?php echo $coiName; ?>" style="color:#fff;">充值</a>
                    </button>
                </div>
            </div>
