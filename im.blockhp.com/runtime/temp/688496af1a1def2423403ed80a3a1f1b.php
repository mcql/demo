<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:39:"./template/mobile/new/index\street.html";i:1555643237;s:38:"./template/mobile/new/public\menu.html";i:1491382656;s:44:"./template/mobile/new/public\footer_nav.html";i:1491382656;s:42:"./template/mobile/new/public\wx_share.html";i:1491382656;}*/ ?>
<!DOCTYPE html >
<html>
<head>
...
<div class="Packages" style="display:felx;">
    ...
    <div class="page_guide_slider">
        ...
        <div class="page_guide_container" onMouseDown="pageGuideMousedown(this,event)"
             ...
             ontouchmove="pageGuideTouchmove(this,event)" ontouchend="pageGuideTouchend(this,event)" style="overflow:hidden;">
...
<script type="text/javascript">
    ...
    function getStreetList() {
        ...
        $.ajax({
            type: "get",
            url: "/index.php/Mobile/Index/ajaxStreetList?p=" + page + "&sc_id=" + cat_id,
            dataType: 'html',
