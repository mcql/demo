<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:49:"./template/mobile/new/user\return_goods_list.html";i:1491382656;s:40:"./template/mobile/new/public\header.html";i:1491382656;s:38:"./template/mobile/new/public\menu.html";i:1491382656;}*/ ?>
<!DOCTYPE html >
<html>
<head>
...
<div class="goods_nav hid" id="menu">
	...
	<div class="main_thh">
    <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>     
		<table width="95%" border="1" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td>状态</td>
				<td>
                    <?php if($item['status'] == 0): ?>待客服处理<?php endif; if($item['status'] == 1): ?>客服处理中<?php endif; if($item['status'] == 2): ?>已完成<?php endif; ?>                
                </td>
			</tr>
			<tr>
