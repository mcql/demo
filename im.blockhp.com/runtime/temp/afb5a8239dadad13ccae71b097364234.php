<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view2/report/user.html";i:1491382650;s:44:"./application/admin/view2/public/layout.html";i:1491382650;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		<div class="mDiv">
			<div class="ftitle">
				<h3>会员统计</h3>
				<h5>今日新增会员：<?php echo $user['today']; ?>|本月新增会员：<?php echo $user['month']; ?>|会员总数：<?php echo $user['total']; ?>|会员余额总额：<?php echo $user['user_money']; ?>|有单会员数：<?php echo $user['hasorder']; ?></h5>
			</div>
