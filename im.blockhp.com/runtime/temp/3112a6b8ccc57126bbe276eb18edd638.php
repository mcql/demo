<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/report/index.html";i:1491382650;s:44:"./application/admin/view2/public/layout.html";i:1491382650;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		<div class="mDiv">
			<div class="ftitle">
				<h3>销售概况</h3>
				<h5>今日销售总额：￥<?php if(empty($today['today_amount']) || ($today['today_amount'] instanceof \think\Collection && $today['today_amount']->isEmpty())): ?>0<?php else: ?><?php echo $today['today_amount']; endif; ?>|人均客单价：￥<?php echo $today['sign']; ?>|今日订单数：<?php echo $today['today_order']; ?>|今日取消订单：<?php echo $today['cancel_order']; ?></h5>
			</div>
