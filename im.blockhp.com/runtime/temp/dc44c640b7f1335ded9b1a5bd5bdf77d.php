<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view2/system/shop_info.html";i:1555773542;s:44:"./application/admin/view2/public/layout.html";i:1491382650;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <form method="post" id="handlepost" action="<?php echo U('System/handle'); ?>" enctype="multipart/form-data" name="form1">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="qq3">平台BHP地址</label>
                </dt>
                <dd class="opt">
                    <input id="shop_address"  name="shop_address" value="<?php echo $config['shop_address']; ?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
