<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./template/mobile/new/goods/goodsinfo.html";i:1555520524;s:38:"./template/mobile/new/public/menu.html";i:1555520524;s:42:"./template/mobile/new/public/wx_share.html";i:1555520524;}*/ ?>
<!DOCTYPE html >
<html>
<head>
...
<!-- JiaThis Button END -->
        ...
        <dl class="goods_price">
          ...
          <dt> <span id="goods_price"><?php echo $goods['shop_price']; ?> BHP</span><font>价格：<?php echo $goods['market_price']; ?> BHP</font> </dt>
        </dl>
...
function get_goods_price()
{
	...
	$("#goods_price").html(goods_price + 'BHP'); // 变动价格显示
...
function ajaxComment(commentType,page){
    $.ajax({
        type : "GET",
        url:"/index.php/Mobile/goods/ajaxComment?goods_id=<?php echo $goods['goods_id']; ?>&commentType="+commentType+"&p="+page,//+tab,
