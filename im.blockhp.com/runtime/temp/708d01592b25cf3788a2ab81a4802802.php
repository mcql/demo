<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/report/salelist.html";i:1491382650;s:44:"./application/admin/view2/public/layout.html";i:1491382650;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		<div class="mDiv">
			...
			<form class="navbar-form form-inline" id="search-form" method="get" action="<?php echo U('Report/saleList'); ?>" onsubmit="return check_form();">
				...
				<div class="sDiv">
					...
					<div class="sDiv2" style="margin-right: 10px;border: none;">
						<select  name="cat_id" id="cat_id" class="form-control">
							...
							<?php if(is_array($categoryList) || $categoryList instanceof \think\Collection): if( count($categoryList)==0 ) : echo "" ;else: foreach($categoryList as $k=>$v): ?>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						<tr>
							...
							<td align="center" class="">
								<div style="text-align: center; width: 50px;"><?php echo $vo['order_id']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 500px;"><?php echo $vo['goods_name']; ?></div>
							</td>
							<td align="center" class="">
							...
							<td align="center" class="">
								<div style="text-align: center; width: 100px;"><?php echo $vo['goods_price']; ?></div>
							</td>
							<td align="center" class="">
								<div style="text-align: center; width: 120px;"><?php echo date("Y-m-d",$vo['add_time']); ?></div>
							</td>
