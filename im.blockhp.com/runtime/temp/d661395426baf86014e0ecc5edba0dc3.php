<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./template/mobile/new/store/store_goods_class.html";i:1555520524;s:38:"./template/mobile/new/public/menu.html";i:1555520524;}*/ ?>
<!DOCTYPE html >
<html>
<head>
...
<dl class="Classification">
	...
	<dd>
		<?php if(is_array($sub_cat[$vo[cat_id]]) || $sub_cat[$vo[cat_id]] instanceof \think\Collection): if( count($sub_cat[$vo[cat_id]])==0 ) : echo "" ;else: foreach($sub_cat[$vo[cat_id]] as $key=>$v2): ?>
		<span>
