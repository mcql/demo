<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:40:"./template/pc/rainbow/newjoin/index.html";i:1554001686;s:40:"./template/pc/rainbow/public/header.html";i:1554001614;s:40:"./template/pc/rainbow/public/footer.html";i:1554001736;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="tpshop-tm-hander p">
    ...
    <div class="nav-middan-z p">
        <div class="header w1224">
			...
			<!--<div class="ecsc-join">
			    <?php $pid =2;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1555833600 and end_time > 1555833600 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
...
<div class="footer p">
    ...
    <div class="w1224">
		...
		<div class="mod_copyright p">
		    ...
		    <p>Copyright © 2016-2025 MIT商城 版权所有 保留一切权利 备案号:粤00-123456号</p>
