<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:37:"./template/pc/rainbow/user/login.html";i:1554001204;s:40:"./template/pc/rainbow/public/footer.html";i:1554001736;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<body>
<div class="header area"> <a href="/index.php" class="logo_s" title="首页" style="margin: 10px 0;height: 59px; "><img style="margin-bottom: 10px;" src="<?php echo $tpshop_config['shop_info_store_logo']; ?>"/></a> </div>
